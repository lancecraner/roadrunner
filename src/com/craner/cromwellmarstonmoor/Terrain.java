...
public class Terrain {
    ...
    public void setLeaderinTile(Leader leader){
        ...
        leader.setDisplayRect(rect);
    	leaders.add(leader);
    }
    
    public void deleteLeaderInTile(Leader leader){
    	// loop through leaders and delete from this tile
    }
